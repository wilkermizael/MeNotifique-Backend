...
function createUser(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, validateUniqueUserOrFail(user)];
                case 1:
                    _c.sent();
                    return [4 /*yield*/, bcryptjs_1.default.hash(password, 12)];
                case 2:
                    hashedPassword = _c.sent();
                    return [2 /*return*/, repositories_1.userRepository.create({
                            user: user,
...
function validateUniqueUserOrFail(user) {
    return __awaiter(this, void 0, void 0, function () {
        var userWithSameEmail;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, repositories_1.userRepository.findByUser(user)];
                case 1:
