...
app
    ...
    .get("/health", function (_req, res) { res.send("I'm OK demais!"); })
    ...
    .use('/uploads', express_1.default.static(path_1.default.join(__dirname, '..', 'uploads')));
function init() {
...
function close() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, config_1.disconnectDB)()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
